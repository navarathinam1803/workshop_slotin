...
- [x] T004 [P] Configure backend formatting (black, ruff) and frontend Prettier
...
- [x] T010 [P] Add pytest and test layout in backend/tests/ (test_services.py placeholder)
...
- [x] T013 [US1] Create WorkshopList component in frontend/src/components/WorkshopList.jsx (or .tsx)
- [x] T014 [US1] Wire home page to fetch and display workshop list (title, date_time, capacity, confirmed_count, waitlisted_count) in frontend/src/App.jsx or pages/Home.jsx
